...
<head>
    ...
    <title>Có lỗi xảy ra ở phía máy chủ — {{ config('app.name') }}</title>
...
<body class="theme-public min-h-screen bg-background text-foreground flex flex-col items-center justify-center px-6 py-20">
    <main class="w-full max-w-lg text-center">
        <p class="chapter-number leading-none">500</p>
        <div class="chapter-rule mx-auto mt-5 mb-7 w-20"></div>

        <h1 class="font-heading text-3xl sm:text-4xl font-semibold leading-tight tracking-tight text-balance">Có lỗi xảy ra ở phía máy chủ</h1>
        <p class="mt-5 text-muted-foreground leading-relaxed">Sự cố đã được ghi lại và đội kỹ thuật sẽ xem. Bạn thử tải lại sau ít phút giúp chúng tôi nhé.</p>
